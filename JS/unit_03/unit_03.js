...
function f9() {
    ...
    if (num >= 1 && num1 <= 32) {
        out.innerHTML = 1;
    } else if (num >= 33 && num1 <= 43) {
        out.innerHTML = 2;
    } else if (num >= 44 && num1 <= 64) {
        out.innerHTML = 3;
    } else {
        out.innerHTML = 0;
    }
...
function f11() {
    let num = +document.querySelector(".s-110").value;
...
function f14() {
    ...
    let sel1 = document.querySelector(".s-143").value;
