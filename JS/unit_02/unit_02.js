...
function t12() {
    let data1 = document.querySelector(".i-12-1");
    let data2 = document.querySelector(".i-12-2");
    let out = document.querySelector(".out-12");
    out.innerHTML = "Hello " + data1.value + " " + data2.value;
}
...
function t13() {
    document.querySelector(".i-13-1").value = a;
    document.querySelector(".i-13-2").value = b;
...
function t16() {
    let data1 = document.querySelector(".i-16-1");
    let data2 = document.querySelector(".i-16-2");
    out = document.querySelector(".out-16");
    out.innerHTML = data1.value + data2.value;
}
...
function t18() {
    ...
    document.querySelector(".out-18").innerHTML = parseInt(a);
}
