...
function f4() {
    let box = document.querySelector(".i-4");
...
function f5() {
    let box = document.querySelector(".i-5");
...
function f6() {
    let box = document.querySelector(".i-6");
...
function f9() {
    let rad = document.querySelector(".r-9");
...
function f10() {
    let col = document.querySelector(".i-10").value;
    document.querySelector(".out-10").style.background = col;
}
...
function f11() {
    let col = document.querySelector(".i-111").value;
    document.querySelector(".i-112").value = col;
}
...
function f12() {
    let col = document.querySelector(".i-12").value;
    document.querySelector(".out-12").innerHTML = col;
}
...
function f13() {
    let col = document.querySelector(".i-13").value;
    document.querySelector(".out-13").innerHTML = col;
}
...
function f14() {
    let col = document.querySelector(".t-14").value;
    document.querySelector(".out-14").innerHTML = col;
}
...
function f15() {
    let col = document.querySelector(".i-15").value;
    document.querySelector(".out-15").innerHTML = col;
    document.querySelector(".t-15").value = col;
}
...
function f16() {
    ...
    let op = document.querySelector(".s-16").value;
    document.querySelector(".out-16").innerHTML = op;
}
...
function f17() {
    let op = document.querySelector(".s-17").value;
    document.querySelector(".out-17").innerHTML = op;
}
...
function f18() {
    let op = document.querySelector(".s-18").value;
    document.querySelector(".i-18").value = op;
}
...
function f19() {
    let tex = document.querySelector(".out-19").innerText;
    document.querySelector(".i-19").value = tex;
}
...
function f20() {
    let col = document.querySelector(".s-201").value;
    document.querySelector(".s-202").value = col;
}
