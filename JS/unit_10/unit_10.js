...
function f1() {
    ...
    div.innerHTML = ar1; // да так можно выводить!!!!
}
...
function f7() {
    ...
    let ar71 = [...ar7, "italy", "turkey", "vietnam"];
    let out = "";
    for (let i = 0; i < ar71.length; i++) {
        out += `${ar71[i]} `;
    }
    div.innerHTML = out;
    console.log(ar71);
...
let ar19 = [15, 424, 313, 78, 241, 7, 77, 78, 45, 4];
...
function f19() {
    ...
    document.querySelector(".out-19").innerHTML = gg;
}
