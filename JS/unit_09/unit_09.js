...
function f5() {
    ...
    div5.innerHTML = out4.classList.contains("bg-orange");
}
...
function f6() {
    par = document.querySelectorAll(".p-6");
    div6 = document.querySelector(".out-6");

    div6.innerHTML = par.length;
}
...
function f7() {
    ...
    outs7 = document.querySelectorAll(".out-7");
...
function f8() {
    ...
    outs8 = document.querySelectorAll(".out-8");
